...
Config.PedCoords = vector3(-861.46, -228.08, 61.02)   -- Create preview ped at these coordinates
Config.HiddenCoords = vector4(-779.0154, 326.1801, 196.0860, 91.0454) -- Hides your actual ped while you are in selection
Config.CamCoords = vector4(-860.57, -225.23, 61.02, 156.86)        -- Camera coordinates for character preview screen
